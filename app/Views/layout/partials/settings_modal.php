    ...
    <div class="modal-content" style="max-width:560px;">
        ...
        <form id="settings-form">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label style="display:flex; align-items:center; width:100%; gap:8px;">
                            <span style="font-weight:600; width:100px;">From Name</span>
            ...
            <div class="settings-panel" id="plugins-panel">
                <p style="font-size:12px; color:var(--text-secondary); margin-bottom:16px;">
                    <i class="fas fa-plug"></i> Enable or disable application plugins. Active plugins reload automatically to register hooks.
                </p>
