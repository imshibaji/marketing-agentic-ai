        ...
        <div class="installer-body">
            ...
            <div class="installer-step active" id="step-1">
                ...
                <div class="check-item">
                    <div class="check-label">
                        ...
                        <span>PHP Version (>= 8.0.0): <strong><?= htmlspecialchars($phpVersion); ?></strong></span>
                    </div>
                    <div class="check-status <?= $phpOk ? 'success' : 'error'; ?>">
                        <i class="fas <?= $phpOk ? 'fa-check-circle' : 'fa-times-circle'; ?>"></i>
                    </div>
                </div>
                ...
                <div class="check-item">
                    <div class="check-label">
                        ...
                        <span>PDO Driver (SQLite/MySQL): <strong><?= $pdoOk ? 'Available' : 'Missing'; ?></strong></span>
                    </div>
                    <div class="check-status <?= $pdoOk ? 'success' : 'error'; ?>">
                        <i class="fas <?= $pdoOk ? 'fa-check-circle' : 'fa-times-circle'; ?>"></i>
                    </div>
                </div>
                ...
                <div class="check-item">
                    <div class="check-label">
                        ...
                        <span>Root Folder Write Permissions: <strong><?= $rootWritable ? 'Writable' : 'Blocked'; ?></strong></span>
                    </div>
                    <div class="check-status <?= $rootWritable ? 'success' : 'error'; ?>">
                        <i class="fas <?= $rootWritable ? 'fa-check-circle' : 'fa-times-circle'; ?>"></i>
                    </div>
                </div>
                ...
                <div class="check-item">
                    <div class="check-label">
                        ...
                        <span>Database Folder Write Permissions: <strong><?= $dbDirWritable ? 'Writable' : 'Blocked'; ?></strong></span>
                    </div>
                    <div class="check-status <?= $dbDirWritable ? 'success' : 'error'; ?>">
                        <i class="fas <?= $dbDirWritable ? 'fa-check-circle' : 'fa-times-circle'; ?>"></i>
                    </div>
                </div>
                ...
                <div class="btn-row">
                    <span></span>
                    <button class="btn btn-primary" id="btn-next-1" <?= !$allChecksPassed ? 'disabled' : ''; ?>>
            ...
            <div class="installer-step" id="step-5">
                <div style="text-align:center; padding: 20px 0;">
                    ...
                    <a href="/" class="btn btn-primary" style="text-decoration:none; padding:12px 32px;">
